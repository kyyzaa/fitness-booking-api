...
class BookingService:
    ...
    def reject_booking(self, booking_id: str, trainer_id: str, reason: str) -> BookingSession:
        """
    ...
    def cancel_booking(self, booking_id: str, user_id: str, reason: str) -> BookingSession:
        """
...
class ClientService:
    ...
    def create_client(self, name: str, email: str, phone: str, 
                     fitness_goals: Optional[str] = None) -> Client:
        """Membuat client baru"""
...
class TrainerService:
    ...
    def create_trainer(self, name: str, email: str, phone: str,
                      specialty: Optional[str] = None,
                      certification: Optional[str] = None,
                      experience: Optional[int] = None) -> Trainer:
