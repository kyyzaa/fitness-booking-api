...
class IBookingSessionRepository(ABC):
    ...
    @abstractmethod
    def find_by_id(self, booking_id: str) -> Optional[BookingSession]:  # pragma: no cover
    ...
    @abstractmethod
    def find_by_client_id(self, client_id: str) -> List[BookingSession]:  # pragma: no cover
        """Mencari booking berdasarkan client ID"""
        pass
    
    @abstractmethod
    def find_by_trainer_id(self, trainer_id: str) -> List[BookingSession]:  # pragma: no cover
